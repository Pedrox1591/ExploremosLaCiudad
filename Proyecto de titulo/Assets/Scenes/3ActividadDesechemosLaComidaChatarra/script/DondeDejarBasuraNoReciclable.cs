...
public class DondeDejarBasuraNoReciclable : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D a)
    {
        ...
        if (a.gameObject.tag == "basuraNoReciclable")
        {
            ...
            a.transform.SetParent(GameObject.Find("b_no_reciclable_ya_ordenada").transform);
