...
public class DondeDejarBasuraVidrios : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D a)
    {
        ...
        if (a.gameObject.tag == "BasuraVidrio")
        {
            ...
            a.transform.SetParent(GameObject.Find("b_vidrios_ya_ordenada").transform);
