...
public class ObjetosQuePertenecenBomberosParte2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        List<GameObject> listafrutas = new List<GameObject>(){fruta1,fruta2,fruta3,fruta4,fruta5,fruta6
        };
        List<GameObject> lista_de_sprites = new List<GameObject>(){posicion1,posicion2,posicion3,posicion4,posicion5,posicion6
        };
